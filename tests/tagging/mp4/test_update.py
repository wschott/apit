...
from apit.file_types.mp4.constants import Mp4Mapping
from apit.file_types.mp4.update import _modify_mp4_file
from apit.file_types.mp4.update import _to_artwork
from apit.file_types.mp4.update import update_metadata
...
def test_metadata_updating(monkeypatch, test_song: Song):
    ...
    monkeypatch.setattr(
        "apit.file_types.mp4.update.read_metadata_raw", lambda *args: mock_mp4_file
    )
...
def test_metadata_updating_with_artwork(monkeypatch, test_song: Song):
    ...
    monkeypatch.setattr(
        "apit.file_types.mp4.update._modify_mp4_file", mock_modify_mp4_file
    )
...
def test_metadata_updating_file_read_error(monkeypatch, test_song):
    ...
    monkeypatch.setattr("apit.file_types.mp4.update.read_metadata_raw", _raise)
